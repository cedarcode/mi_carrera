...
[
  ...
  ["Introducción a la Investigación de Operaciones", 10, "IIO", 5],
  ...
  ["Práctica de Administración para Ingenieros", 5, "PAI", 6],
  ...
  Course.where(name: course_data[0]).first_or_create.update!(credits: course_data[1], semester: course_data[2], short_name: course_data[3])
end
