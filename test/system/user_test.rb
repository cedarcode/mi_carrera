...
class UserTest < ApplicationSystemTestCase
  ...
  test "can sign up" do
    ...
    password_visibility_toggle_test("#password-container")
    password_visibility_toggle_test("#password_confirmation-container")
    click_on "Registrarte"
  ...
  test "can edit profile" do
    ...
    password_visibility_toggle_test("#password-container")
    password_visibility_toggle_test("#password_confirmation-container")
    password_visibility_toggle_test("#current_password-container")
